<template>
    <section class="app__status">
        <div class="status__content" v-if="this.getReservedPlaceID !== null">
            ...
            <div class="code">
                <img :src="`http://qrcoder.ru/code/?${this.getReservedPlaceID}&4&0`" width="116" height="116" border="0" title="QR код">
        ...
        <div class="cancelBTN" v-if="(this.getPageSize === 'desktop') && (this.getReservedPlaceID !== null)"
...
<style lang="scss" scoped>
    .app__status{
        ...
        .status__content{
            ...
            height: 80rem;
            background:white;
            box-shadow: 0rem .9rem .4rem rgba(0, 0, 0, 0.25);
